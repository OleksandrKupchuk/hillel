...
public class Page {
    ...
    public void checkSuccessLoginTitle() {
        ...
        WebElement title = waitElement.waitAndGetOfVisibilityElement(By.xpath("//h2"));
    ...
    public void checkInvisibilityLoaderWithExplicitWait() {
        ...
        waitElement.waitOfVisibilityElement(By.id("loading"));
        Assert.assertTrue(waitElement.waitOfInvisibilityElement(By.id("loading")));
        WebElement successLoadingTitle = waitElement.waitAndGetOfVisibilityElement(By.cssSelector("#finish h4"));
    ...
    public void checkInvisibilityLoaderWithFluentWait() {
        ...
        WebElement successLoadingTitle = waitElement.fluentWaitOnElement(By.cssSelector("#finish h4"));
        Assert.assertEquals(successLoadingTitle.getText(), "Hello World!");
    ...
    public void checkScroll() {
        ...
        waitElement.waitOfInvisibilityElement(By.xpath("(//div[@class='jscroll-added'])[3]"));
